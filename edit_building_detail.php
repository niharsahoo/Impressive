...
<title>High Clean Admin - Quotes Buildings</title>
                ...
                <form class="form-horizontal" method="post">
                  <div class="col-md-5 mr100">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="account_name" value="Office Building" class="form-control" />
                      </div>
                    </div>
                    <!-- form-group -->
                  ...
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="account_name" value="40" class="form-control" />
                      </div>
                    </div>
                    <!-- form-group -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="account_name" value="3" class="form-control" />
                      </div>
                    </div>
                    <!-- form-group -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="account_name" value="2500" class="form-control" />
                      </div>
                    </div>
                    <!-- form-group -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <textarea cols="4" name="note" class="form-control"></textarea>
                      </div>
                    </div>
                    <!-- form-group --> 
