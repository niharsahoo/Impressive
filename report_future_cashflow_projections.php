...
<title>High Clean Admin - Report Future CashFlow Projections</title>
      ...
      <div class="pageheader">
        <div class="media">
          <div class="media-body">
            ...
            <h4>Future Cash Flow Projections</h4>
          </div>
        </div>
        <!-- media --> 
      </div>
          ...
          <div class="col-md-12 report_scetion">
            ...
            <div class="panel panel-default">
              <div class="panel-body titlebar"> <span class="glyphicon  glyphicon-th"></span>
                <h2>Future Cash Flow Projections</h2>
              </div>
            </div>
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-bordered mb30 quote_table">
                  <thead>
                    <tr>
                      <th colspan="7" align="right" class="btnright"> <a href="#" class="btn btn-default mr5">Export XLS</a> <a href="#" class="btn btn-default">Export PDF</a> </th>
                    </tr>
                    <tr>
                      <th class="head">Date Booked</th>
