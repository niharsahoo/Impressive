...
<html lang="en">
    <head>
        ...
        <title>High Clean Admin - User Deactivate</title>
        ...
        <!-- media --> 
                ...
                <div class="panel panel-default">
                  <div class="panel-body titlebar">
                    <span class="fa fa-pencil"></span><h2>Deactivate User</h2>
                  </div>
                </div>
                <div class="alert alert-warning"> <span class="fa fa-warning mr10"></span> <!--<strong>Warning!</strong>-->  You want to deactivate this 'admin' user? </div>
                <div align="center">
