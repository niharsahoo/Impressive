...
<title>High Clean Admin - Users</title>
          ...
          <div class="col-md-12 user_section"> 
                ...
                <div class="panel panel-default">
                  <div class="panel-body titlebar">
                    <span class="fa fa-pencil"></span><h2>Edit User</h2>
                  </div>
                </div>
                <div class="col-md-12">
                  <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="col-md-5 mr100">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" name="account_name" value="admin" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" name="account_name" value="Super" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" name="account_name" value="2013-11-01" class="form-control" />
                        </div>
                      </div>
                    ...
                    <div class="col-md-5">
                      ...
                      <div class="form-group">
                        <label class="col-sm-5">What are you interested in?</label>
                        <div class="col-sm-7">
                          <span class="block"><input type="radio" name="" value="" /> Product Sales </span>
                          <span class="block"><input type="radio" name="" value="" /> Cleaning Services </span>
                        </div>
                      </div>
                    </div>
