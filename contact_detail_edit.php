...
<title>High Clean Admin - Edit Contact</title>
            ...
            <div class="col-md-6">
              <form class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <select data-val="true" data-val-number="The field CompanyId must be a number." data-val-required="The CompanyId field is required." name="CompanyId" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="Noel" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="Josiane" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="11 Compark Circuit" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="Mulgrave" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="VIC" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="3170" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="0385278888" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="0402216871" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="noel.josiane@secureclean.com.au" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="Business Manager" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
                
                <div class="form-group">
                  <label class="col-sm-5">Number of sites managed</label>
                  <div class="col-sm-7">
