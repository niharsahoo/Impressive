...
<title>High Clean Admin - Report Job Payment</title>
        ...
        <div class="row">
          <div class="col-md-12 report_scetion">
            ...
            <div class="col-md-6">
              <form class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" name="account_name" value="0" class="form-control" />
                  </div>
                </div>
                <!-- form-group -->
            ...
            <div class="col-md-12 pl0 pr0">
              <div class="table-responsive overflow_x">
                <table class="table table-bordered mb30 quote_table report_job_payment">
                  <thead>
                    <tr>
                    ...
                    <tr>
                      ...
                      <th class="head">Contact Email</th>
                      <th class="head">Contact Phone/Mobile</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Secure Clean</td>
                      <td>Chad</td>
                      <td>chad.monkhouse@secureclean.com.au</td>
                      <td>0385278888 / 0423594935</td>
                      <td>DFO Essendon</td>
