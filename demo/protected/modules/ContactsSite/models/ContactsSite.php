...
class ContactsSite extends CActiveRecord
{
   public $concatedAddress;
	...
	public function rules()
	{
		...
		return array(
			array('site_name, site_id, address, suburb, state, postcode, phone, mobile,site_contact, site_comments, how_many_buildings', 'required'),
			array('how_many_buildings', 'numerical', 'integerOnly'=>true),
			array('site_name, suburb, site_id, state, postcode, phone, mobile, email, site_contact, site_comments', 'length', 'max'=>255),
			...
			array('id, site_name, site_id, concatedAddress, address, suburb, state, postcode, phone, mobile, email, site_contact, site_comments, how_many_buildings, created_at, updated_at, need_induction, status', 'safe', 'on'=>'search'),
		);
	}
