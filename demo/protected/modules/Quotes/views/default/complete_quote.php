        ...
        <div class="table-responsive">
          <table width="100%" border="0" align="center" class="table table-bordered mb30 quote_table">
            <tr>
              ...
              <th  width="20%" class="head">Photo</th>
            </tr>
...
$quote_building_service_total += $ServiceRow->total; ?>
	...
	<a href="<?php echo Yii::app()->getBaseUrl(true).'/?r=Quotes/default/DeleteQuote&id='.$_REQUEST['qid']; ?>" class="btn ptpb btn-primary mr5">Cancel Quote</a>
	<a href="<?php echo Yii::app()->getBaseUrl(true).'/?r=Quotes/default/BuildingService&qid='.$_REQUEST['qid']; ?>" class="btn btn-primary ptpb mr5">Back</a> 
