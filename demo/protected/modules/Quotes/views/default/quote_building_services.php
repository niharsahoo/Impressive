...
$this->widget('zii.widgets.grid.CGridView', array(
 ...
 'edit' => array( // My custom button options
        ...
        <div class="col-md-6 mb30">
          ...
          <textarea cols="80" rows="4" class="form-control mb20" name="staff_contr[<?php echo $buiding_single_row['job_id']; ?>]"><?php if(isset($buiding_single_row['si_staff_contractor'])) echo $buiding_single_row['si_staff_contractor']; ?>
</textarea>
          <div class="panel panel-default">
            <div class="panel-body titlebar"> <span class="glyphicon  glyphicon-th"></span>
...
?>
        ...
        <div class="col-md-6">
          ...
          <textarea  cols="80" rows="4" class="form-control mb20" name="client[<?php echo $buiding_single_row['job_id']; ?>]"><?php if(isset($buiding_single_row['si_client'])) echo $buiding_single_row['si_client']; ?>
</textarea>
          <div class="panel panel-default">
            <div class="panel-body titlebar"> <span class="glyphicon  glyphicon-th"></span>
...
?>
    ...
    <?php } ?>
    <div class="row buttons aligncenter"> <a href="<?php echo Yii::app()->getBaseUrl(true).'/?r=Quotes/default/update&id='.$_REQUEST['qid']; ?>" class="btn btn-primary mr5">Back</a> <?php echo CHtml::submitButton('Save & Continue', array('class' => 'btn btn-primary')); ?> </div>
  </div>
</div>
