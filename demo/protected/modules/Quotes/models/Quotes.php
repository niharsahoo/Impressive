...
class Quotes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('company_id, contact_id, site_id, service_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, company_id, contact_id, site_id, service_id, quote_date, status, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
