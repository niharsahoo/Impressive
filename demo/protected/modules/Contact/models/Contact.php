...
class Contact extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('company_id, first_name, surname, address, suburb, state, postcode, phone, mobile,position, no_of_sites_managed', 'required'),
			array('company_id, no_of_sites_managed', 'numerical', 'integerOnly'=>true),
