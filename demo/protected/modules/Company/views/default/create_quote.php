        ...
        <div class="media">
          <div class="media-body">
            <ul class="breadcrumb">
              ...
              <li><a href="<?php echo Yii::app()->getBaseUrl(true); ?>/?r=Company/default/admin">Company</a></li>
              <li>Add New Quote</li>
            </ul>
	 ...
	 <div class="table-responsive">
                ...
                <tr>
					...
					<?php echo $form->dropDownList($quote_model, 'service_id', CHtml::listData(Service::model()->findAll(), 'id', 'service_name'),array('class'=>'form-control')); ?>
                      ...
                      <a target="_blank" href="<?php echo Yii::app()->getBaseUrl(true); ?>/?r=Company/default/create" title="Create new company">Create new company</a>
					  </td>
...
<?php echo $form->dropDownList($quote_model, 'contact_id',$contacts_options,array('onchange' => 'return FindContactSites(this.value);','class'=>'form-control','id' => 'company_contacts') ); ?>						  
                      ...
                      <a target="_blank" href="<?php echo Yii::app()->getBaseUrl(true); ?>/?r=Contact/default/create" title="Create new contact">Create new contact</a>
                      </td>
...
<?php echo $form->dropDownList($quote_model, 'site_id',$sites_options,array('onchange' => 'return FindSiteBuildings(this.value);','class'=>'form-control','id' => 'contact_sites') ); ?>						  
                      ...
                      <a target="_blank" href="<?php echo Yii::app()->getBaseUrl(true); ?>/?r=ContactsSite/default/create" title="Create new site">Create new site</a>
                      </td>
 </tr>
...
?>					
                      ...
                      <td>
						...
						<?php if(isset($buildings_options)) echo $buildings_options; ?>							
                         ...
                         <a target="_blank" href="<?php echo Yii::app()->getBaseUrl(true); ?>/?r=Buildings/default/create" title="Create new building">Create new building</a>
