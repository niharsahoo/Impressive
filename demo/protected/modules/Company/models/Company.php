...
class Company extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, office_address, office_suburb, mailing_address, mailing_suburb, abn, phone, mobile, number_of_site, office_state, office_postcode, mailing_state, mailing_postcode', 'required'),
			array('number_of_site', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, office_address, office_suburb, mailing_address, mailing_suburb, abn, phone, mobile, fax, email, website, number_of_site, office_state, office_postcode, mailing_state, mailing_postcode, created_at, updated_at, status', 'safe', 'on'=>'search'),
		);
	}
