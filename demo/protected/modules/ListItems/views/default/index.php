...
<div class="col-md-6 mb20">
                <!--  <form class="form-horizontal" method="post" enctype="multipart/form-data">-->
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
					    <input type="hidden" name="list_display_for_client_id" id="list_display_for_client_id" value="" class="form-control">
                        <input type="text" name="list_display_for_client_name" id="list_display_for_client_name" value="" class="form-control">
                      </div>
                    </div>
                    <!-- form-group -->
                    ...
                    <div class="form-group">
                     <label class="col-sm-5">&nbsp;</label>
                      <div class="col-sm-7">
						...
						<button class="btn btn-default mr5" id="list_type_5_addbtn2" style="display:none;" onclick="reset_list_display_for_client_form();" >Reset</button>
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'list_type_5-grid',
	'dataProvider'=>$list_display_for_client_model->search(),
	'filter'=>$list_display_for_client_model,
	'itemsCssClass' => 'table table-bordered mb30 quote_table',	
	'pagerCssClass'=>'pagination',
	'columns'=>array(
		array(
		...
		array(
			...
			'buttons'=>array
					...
					//console.log(data.name);
                                              //$('#AjFlash').html(data).fadeIn().animate({opacity: 1.0}, 3000).fadeOut('slow');
											//$.fn.yiiGridView.update('list_type_3-grid');
											$('#list_display_for_client_name').val(data.name);
											$('#list_display_for_client_id').val(data.id);
