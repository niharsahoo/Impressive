...
class Buildings extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('site_id, building_type_id,no_of_floors', 'numerical', 'integerOnly'=>true),
			...
			array('id, building_name, building_no, water_source_availability, dist_from_office, no_of_floors, size_of_building, height_of_building, job_notes, site_id, building_type_id, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
